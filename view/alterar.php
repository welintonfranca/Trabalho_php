...
<form action="alterar.php" method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" id="problemaConstatado" name="problemaConstatado" required autofocus class="form-control"
               value="<?php echo $resultado['problemaConstatado']; ?>">
    </div>
    <div class="form-group">
        <label for="solucao">Solução</label>
        <input type="text" id="solucao" name="solucao" required class="form-control"
               value="<?php echo $resultado['solucao']; ?>">
    </div>
    <div class="form-group">
        <label for="valor">Valor</label>
        <input type="text" id="valor" name="valor" class="form-control"
               value="<?php echo \App\Helper\Moeda::get($resultado['valor']); ?>">
    </div>
    <div class="form-group">
        <label for="dataFechamento">Data de Fechamento</label>
        <input type="date" id="dataFechamento" name="dataFechamento" class="form-control"
               value="<?php echo $resultado['dataFechamento']; ?>">
    </div>
